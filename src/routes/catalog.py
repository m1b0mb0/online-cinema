...
@router.get(
    ...
    summary="List Genres",
    description="Return a paginated, optionally searchable list of movie genres.",
)
...
@router.post(
    ...
    responses={409: {"description": "A genre with this name already exists."}},
)
...
@router.post(
    ...
    dependencies=[Depends(get_moderator_or_admin_user)],
    responses={409: {"description": "An actor with this name already exists."}},
)
